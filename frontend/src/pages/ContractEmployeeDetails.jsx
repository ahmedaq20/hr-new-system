...
function ContractEmployeeDetails() {
        ...
        return (
            <div className="d-flex justify-content-center align-items-center" style={{ minHeight: "80vh" }}>
                <div className="text-center">
                    ...
                    <p className="mt-2 text-secondary">جارٍ تحميل بيانات الموظف (عقود)...</p>
                </div>
            </div>
        );
    }
    ...
    if (error || !employee) {
        return (
            <div className="container mt-5 text-center">
                ...
                <Button variant="primary" onClick={() => navigate(-1)}>العودة للصفحة السابقة</Button>
            </div>
        );
    }
                ...
                <div className="bg-white rounded-4 shadow-sm p-4 animate-fade-in border-top border-5" style={{ borderTopColor: '#002F6C !important' }}>
                    <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                        <h4 className="fw-bold mb-0 text-dark">
                            ...
                            تعديل بيانات {employee.full_name} (عقود)
                        </h4>
...
export default ContractEmployeeDetails;
