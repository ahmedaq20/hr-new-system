...
import Programs2Modal from "./Programs2Modal";
import Pagination from "./Pagination";
import { usePermissions } from "../hooks/usePermissions";

function Programs2Table({ employees, onUpdate, onDelete, isMutating }) {
  ...
  const handleDelete = (id) => {
    ...
    if (window.confirm(`هل أنت متأكد أنك تريد حذف البرنامج "${item.value}"؟`)) {
      onDelete(id);
    }
  };
