...
function CourseClassificationModal({ show, onClose, onSave, item = null, isMutating }) {
        ...
        >
            ...
            >
                <Modal.Title className="fs-5 fw-bold text-white">
                    {isEdit ? "تعديل تصنيف التدريب" : "إضافة تصنيف تدريب جديد"}
                </Modal.Title>
            </Modal.Header>
...
export default CourseClassificationModal;
