...
import CourseClassificationModal from "./CourseClassificationModal";
import Pagination from "./Pagination";

function CourseClassificationsTables({ employees, onUpdate, onDelete, isMutating }) {
  ...
  const handleDelete = (id) => {
    ...
    if (window.confirm(`هل أنت متأكد أنك تريد حذف تصنيف الدورة "${item.value}"؟`)) {
      onDelete(id);
    }
  };
