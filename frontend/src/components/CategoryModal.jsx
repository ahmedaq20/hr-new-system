...
function CategoryModal({ show, onClose, onSave, item = null, isMutating }) {
        ...
        >
            ...
            <Modal.Body className="p-4 bg-light">
                <Form className="text-end">
                    <Form.Group className="mb-0">
                        <Form.Label className="fw-bold text-secondary small">اسم الفئة</Form.Label>
                        <Form.Control
                            type="text"
            ...
            <Modal.Footer className="border-0 pb-4 px-4 bg-light rounded-bottom-4">
                ...
                <Button
                    ...
                    disabled={isMutating}
                >
                    {isMutating ? (isEdit ? 'جاري الحفظ...' : 'جاري الإضافة...') : (isEdit ? "حفظ التغييرات" : "إضافة الفئة")}
                </Button>
            </Modal.Footer>
        </Modal>
    );
