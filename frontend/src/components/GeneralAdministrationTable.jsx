...
import GeneralAdminstrationModal from "./GeneralAdminstrationModal";
import Pagination from "./Pagination";
import { usePermissions } from "../hooks/usePermissions";

function GeneralAdministrationTable({ employees, onUpdate, onDelete, isMutating }) {
  ...
  const handleDelete = (id) => {
    ...
    if (window.confirm(`هل أنت متأكد أنك تريد حذف الإدارة العامة "${item.value}"؟`)) {
      onDelete(id);
    }
  };
