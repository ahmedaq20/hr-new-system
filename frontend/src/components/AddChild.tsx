...
import { useAddEmployeeChild } from "../hooks/useEmployeeChildren";
...
const AddChild: React.FC<AddChildProps> = ({ show, handleClose }) => {
    ...
    const addChildMutation = useAddEmployeeChild();
    ...
    const validate = () => {
        ...
        if (!idCardImage && !birthCertificateImage) {
        ...
        if (formData.is_university_student && !universityCertificateImage) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await addChildMutation.mutateAsync(data);
                ...
                <Card className="p-4 border-0 shadow-sm" style={{ borderRadius: "15px", background: "#fff" }}>
                    ...
                    <Form onSubmit={handleSubmit}>
                            ...
                            <Col md={6}>
                                <div className="d-flex align-items-center gap-4 h-100 pt-4">
                                    <div className="d-flex align-items-center gap-2">
                                        <Form.Label htmlFor="is-working-child" className="mb-0 fw-bold" style={{ cursor: 'pointer' }}>يعمل</Form.Label>
                                        <Form.Check
                                            type="checkbox"
                                            id="is-working-child"
                                            name="is_working"
                                    ...
                                    <div className="d-flex align-items-center gap-2">
                                        <Form.Label htmlFor="is-university-student" className="mb-0 fw-bold" style={{ cursor: 'pointer' }}>طالب جامعي</Form.Label>
                                        <Form.Check
                                            type="checkbox"
                                            id="is-university-student"
                        ...
                        <Row className="mb-4">
                            ...
                            <Col md={6}>
                                <Form.Group>
                                    <Form.Label className="fw-bold">صورة شهادة الميلاد <span className="text-secondary" style={{ fontSize: '0.8rem' }}>(مطلوب واحد منهما على الأقل)</span></Form.Label>
                                    <Form.Control
                                        type="file"
                                        accept=".pdf,.jpg,.jpeg,.png"
                        ...
                        <div className="d-flex justify-content-end gap-2 mt-4">
                            ...
                            >
                                {addChildMutation.isPending ? <Spinner animation="border" size="sm" /> : "حفظ الطلب"}
                            </Button>
                        </div>
                    </Form>
                </Card>
