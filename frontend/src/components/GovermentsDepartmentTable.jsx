...
import GovermentDepartmentModal from "./GovermentDepartmentModal";
import Pagination from "./Pagination";
import { usePermissions } from "../hooks/usePermissions";

function GovermentsDepartmentTable({ employees, onUpdate, onDelete, isMutating }) {
  ...
  const handleDelete = (id) => {
    ...
    if (window.confirm(`هل أنت متأكد أنك تريد حذف الدائرة "${item.value}"؟`)) {
      onDelete(id);
    }
  };
