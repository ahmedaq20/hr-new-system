...
import WorkContractsModal from "./WorkContractsModal";
import Pagination from "./Pagination";
import { usePermissions } from "../hooks/usePermissions";

function WorkContractsTable({ employees, onUpdate, onDelete, isMutating }) {
  ...
  const handleDelete = (id) => {
    ...
    if (window.confirm(`هل أنت متأكد أنك تريد حذف نوع العقد "${item.value}"؟`)) {
      onDelete(id);
    }
  };
