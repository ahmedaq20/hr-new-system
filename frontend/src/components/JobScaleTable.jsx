...
import JobScaleModal from "./JobScaleModal";
import Pagination from "./Pagination";
import { usePermissions } from "../hooks/usePermissions";

function JobScaleTable({ employees, onUpdate, onDelete, isMutating }) {
  ...
  const handleDelete = (id) => {
    ...
    if (window.confirm(`هل أنت متأكد أنك تريد حذف السلم "${item.value}"؟`)) {
      onDelete(id);
    }
  };
