...
function DegreeModal({ show, onClose, onSave, item = null, isMutating }) {
        ...
        >
            ...
            >
                <Modal.Title className="fs-5 fw-bold text-white">
                    {isEdit ? "تعديل الدرجة" : "إضافة درجة جديدة"}
                </Modal.Title>
            </Modal.Header>
            <Modal.Body className="p-4 bg-light">
                <Form className="text-end">
                    <Form.Group className="mb-0">
                        <Form.Label className="fw-bold text-secondary small">الدرجة الوظيفية</Form.Label>
                        <Form.Control
                            type="text"
                            placeholder="أدخل اسم أو رقم الدرجة..."
            ...
            <Modal.Footer className="border-0 pb-4 px-4 bg-light rounded-bottom-4">
                ...
                <Button
                    ...
                    disabled={isMutating}
                >
                    {isMutating ? (isEdit ? 'جاري الحفظ...' : 'جاري الإضافة...') : (isEdit ? "حفظ التغييرات" : "إضافة الدرجة")}
                </Button>
            </Modal.Footer>
        </Modal>
    );
